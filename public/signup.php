<?php
   ...
   //If it is a post add the new member and redirect to bird-staff/index.php
   if(is_post_request()) {
     ...
     if($result === true) {
       $session->login($admin);
       $session->message('You are now a member of WNC Birds. You can now edit the list of birds.');
